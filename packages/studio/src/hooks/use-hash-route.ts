...
export type HashRoute =
  ...
  | { page: "book-create"; mode?: "create" | "import" }
  | { page: "services" }
...
function parseHash(hash: string): HashRoute {
  ...
  if (path === "book/new") return { page: "book-create", mode: "create" };
  if (path === "book/import") return { page: "book-create", mode: "import" };
...
function routeToHash(route: HashRoute): string {
  switch (route.page) {
    ...
    case "book-create": return route.mode === "import" ? "#/book/import" : "#/book/new";
